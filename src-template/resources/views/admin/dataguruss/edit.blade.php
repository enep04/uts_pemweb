...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.dataguruss.update', [$dataguru->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_guru') ? 'is-invalid' : '' }}" type="text" name="nama_guru" id="nama_guru" value="{{ old('nama_guru', $dataguru->nama_guru) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ttl') ? 'is-invalid' : '' }}" type="text" name="ttl" id="ttl" value="{{ old('ttl', $dataguru->ttl) }}">
                @if($errors->has('ttl'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ttl') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $dataguru->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('riwayat_pendidikan') ? 'is-invalid' : '' }}" name="riwayat_pendidikan" id="riwayat_pendidikan">
                    ...
                    @foreach(App\Models\Dataguru::RIWAYAT_PENDIDIKAN as $key => $label)
                        <option value="{{ $key }}" {{ old('riwayat_pendidikan', $dataguru->riwayat_pendidikan) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('universitas') ? 'is-invalid' : '' }}" type="text" name="universitas" id="universitas" value="{{ old('universitas', $dataguru->universitas) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mata_pelajaran') ? 'is-invalid' : '' }}" type="text" name="mata_pelajaran" id="mata_pelajaran" value="{{ old('mata_pelajaran', $dataguru->mata_pelajaran) }}" step="1">
